...
#define JPEG_USE_MALLOC		0		//�����Ƿ�ʹ��malloc,0 not use, 1 use.
#define JPEG_WBUF_SIZE  	0x2000	//���幤���������С,����Ӧ��С��3092�ֽ�.

//jpg pic strcut
//#define jpeg_file		((uint8_t*)PIC_BASE)
#define jpeg_dev		((JDEC*)(PIC_BASE))
#define jpeg_fil		((FIL*)(PIC_BASE + jpeg_dev_size))
#define jpg_buffer		((uint8_t*)(PIC_BASE + jpeg_dev_size + jpeg_fil_size))

//#define jpeg_file_size	((uint32_t)0x2000)
#define jpeg_dev_size	((uint32_t)0x400)
#define jpeg_fil_size	((uint32_t)0x600)
#define jpg_buffer_size	((uint32_t)JPEG_WBUF_SIZE)
//---------------------------------
